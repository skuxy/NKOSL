...
\begin{frame}
    ...
    \shell{lvcreate myVolumeGroup --size 20GB  --name my20GB}

    \shell{mkfs.ext2 /dev/myVolumeGroup/my20GB}
  
    \shell{mount --types ext2 /dev/myVolumeGroup/my20GB /media/backup}

    \shell{chmod --recursive 755 /media/backup}
